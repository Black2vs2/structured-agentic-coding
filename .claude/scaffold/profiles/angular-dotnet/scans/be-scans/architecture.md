...
```
Grep pattern: "using __BE_NAMESPACE__\.(Application|Migrations|Api)"
     path:    backend/src/__BE_NAMESPACE__.Domain
     output_mode: content
```
- **True positive:** `using __BE_NAMESPACE__.Application.Something;` in any Domain file
...
```
Grep pattern: "using __BE_NAMESPACE__\.(Api|Migrations)"
     path:    backend/src/__BE_NAMESPACE__.Application
     output_mode: content
```
- **True positive:** `using __BE_NAMESPACE__.Api.Controllers;` in a handler file
...
```
Grep pattern: "using __BE_NAMESPACE__\.Api"
     path:    backend/src/__BE_NAMESPACE__.Migrations
     output_mode: content
```
- **True positive:** `using __BE_NAMESPACE__.Api.Auth;` in a configuration file
- **False positive:** None
