...
cp .claude/commands/init-agentic.md ~/.claude/commands/

# Copy the scaffold templates
cp -r .claude/scaffold ~/.claude/scaffold
```

Then run `/init-agentic` in any project.

### Option B: Per-project

Copy `.claude/commands/init-agentic.md` and `.claude/scaffold/` into the target project, then run `/init-agentic`.
