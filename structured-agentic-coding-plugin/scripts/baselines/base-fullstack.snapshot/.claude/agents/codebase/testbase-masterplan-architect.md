...
# Test Base Masterplan Architect
...
- Include build commands: `echo build` for BE, `npm run build` for FE
- Include format commands: `echo format` for BE, `npm run format` for FE
- Include test commands: `echo test` for BE, `npm run test` for FE
