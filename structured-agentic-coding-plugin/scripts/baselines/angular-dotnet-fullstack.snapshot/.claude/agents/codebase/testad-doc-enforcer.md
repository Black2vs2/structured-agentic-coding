...
# Test Angular Dotnet Documentation Enforcer
...
- Scan playbooks in `backend/.claude/agents/be-scans/` and `frontend/.claude/agents/fe-scans/`
...
- Layer-level: Glob for project directories under `backend/src/*/`
...
- Core libraries: Glob for library directories under `frontend/` (e.g., `frontend/libs/core/*/`, `frontend/src/app/core/*/`)
- Feature modules: Glob for feature directories (e.g., `frontend/libs/features/*/`, `frontend/src/app/features/*/`)
- Page modules: Glob for page directories (e.g., `frontend/libs/pages/*/`, `frontend/src/app/pages/*/`)
...
1. **Discover backend significant directories:**
   - Layer-level: Glob for project directories under `backend/src/*/` (or `backend/*/` depending on project structure)
