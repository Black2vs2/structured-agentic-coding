...
# Test Refine NestJS Query FE Masterplan Executor
...
- Files under `./` -> dispatch to FE Feature Developer with those files
...
6. **Output completion report** and save it to a file.
   ...
   **Masterplan:** {masterplan_path}
   ...
   3. Start frontend: cd . && <frontend serve command>
