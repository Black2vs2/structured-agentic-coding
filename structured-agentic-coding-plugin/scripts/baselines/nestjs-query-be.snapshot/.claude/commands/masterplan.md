...
4. Self-grill — dispatch an independent `masterplan-griller` subagent per round, auto-apply critical findings, stash major findings for User-Grill (max 3 rounds, early exit on `verdict: pass`)
