...
```
Glob pattern: "backend/src/__BE_NAMESPACE__.*/ARCHITECTURE.md"
```
...
```
Glob pattern: "backend/src/__BE_NAMESPACE__.Application/*/ARCHITECTURE.md"
```

Cross-reference against: `Glob("backend/src/__BE_NAMESPACE__.Application/*/")`.
...
```
Glob pattern: "backend/src/__BE_NAMESPACE__.Api/*/ARCHITECTURE.md"
```

Cross-reference against: `Glob("backend/src/__BE_NAMESPACE__.Api/*/")`.
...
```
Glob pattern: "backend/src/__BE_NAMESPACE__.*/GUIDELINES.md"
```

**Scan 2 -- Feature directories:**
```
Glob pattern: "backend/src/__BE_NAMESPACE__.Application/*/GUIDELINES.md"
```

**Scan 3 -- Module directories:**
```
Glob pattern: "backend/src/__BE_NAMESPACE__.Api/*/GUIDELINES.md"
```
