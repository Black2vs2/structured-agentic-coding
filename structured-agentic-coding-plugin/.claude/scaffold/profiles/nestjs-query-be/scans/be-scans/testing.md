...
**Scan:**
```
Glob pattern: __BE_DIR__/src/**/*.test.ts
```
Any match is a violation — should be renamed to `.spec.ts`.

Also:
```
Glob pattern: __BE_DIR__/src/**/*.spec.ts
```
...
```
Bash: __BE_TEST__ --coverage --coverageReporters=json-summary
```
