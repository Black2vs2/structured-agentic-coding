...
**Scan:**
```
Glob pattern: __FE_DIR__/src/**/*.graphql
Glob pattern: __FE_DIR__/src/**/*.gql
```
...
**Scan:**
```
Bash: git log --oneline -- __FE_DIR__/src/graphql/types.ts __FE_DIR__/src/graphql/schema.types.ts 2>/dev/null | head -20
```
