...
Grep pattern: "modelBuilder\.Entity<"
     path:    backend/src/__BE_NAMESPACE__.Migrations/Data/AppDbContext.cs
     output_mode: content
```
...
Grep pattern: "ToJson|jsonb|HasColumnType.*json"
     path:    backend/src/__BE_NAMESPACE__.Migrations/Data
     output_mode: content
     -i:      true
```
...
**Scan:**
```
Glob pattern: backend/src/__BE_NAMESPACE__.Migrations/Migrations/2*.cs
```
...
Grep pattern: "protected override void Down"
     path:    backend/src/__BE_NAMESPACE__.Migrations/Migrations
     output_mode: content
     context: 3
     glob:    "2*.cs"
```
